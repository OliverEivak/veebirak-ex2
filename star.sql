...
Antares gets its name from the ancient Greeks. It means Anti-Ares. Ares is, of course, the Greek god of War who is also called Mars by the Romans.
Antares is linked to the planet Mars because they are both about the same color and the same brightness, so it is easy to get them confused.');
