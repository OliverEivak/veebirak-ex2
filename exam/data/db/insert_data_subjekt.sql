...
INSERT INTO user_account (subject_type_fk, subject_fk,username, passw,status) VALUES (3,1,'juhan','$2a$06$KBkRPtHZ885IKg0CWbZTM.I0nmDv5M0xjKU8aB3eNmgA/TH2SlqVm',1);
...
-- parool on best
INSERT INTO user_account (subject_type_fk, subject_fk,username, passw,status) VALUES (3,2,'marten','$2a$06$0Ak6R5i/5j1NfUuC2QISWOGB6ulDmUF1GOZRKGFV0nSPd8X3mkW12',1);
...
-- parool on next
INSERT INTO user_account (subject_type_fk, subject_fk,username, passw,status) VALUES (3,3,'tanel','$2a$06$0OY4tdQRAWcCX7an1f6j6.okioeDejGtcTZDTAn2Bi18qqhBHuodO',1);
...
INSERT INTO subject_attribute_type (subject_type_fk,type_name,data_type,multiple_attributes,orderby,required) VALUES (2,'laste arv',2,'N',2,'N');
...
INSERT INTO subject_attribute (subject_fk,subject_attribute_type_fk,subject_type_fk, value_number,data_type) VALUES (1,4,3,12,2);
